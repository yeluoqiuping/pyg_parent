...
public class UserServiceImpl implements UserService {
	...
	public void sendCheckCode(String phone) {
		...
		System.out.println("验证码是："+numeric);
		//redisTemplate.boundHashOps("checckCode").put(phone,numeric);
		...
		jmsTemplate.send(smsDestination, new MessageCreator() {
			...
			public Message createMessage(Session session) throws JMSException {
				...
				mapMessage.setString("param",numeric);
	...
	public boolean checkCode(String smscode, String phone) {
		...
		String numeric = (String) o;
		if (!smscode.equals(numeric)){
		return false;
		}
